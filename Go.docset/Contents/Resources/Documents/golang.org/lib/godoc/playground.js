...
(function() {
  ...
  function playground(opts) {
    ...
    function origin(href) {
      return (""+href).split("http://golang.org/").slice(0, 3).join("http://golang.org/");
    }
  
    var pushedEmpty = (window.location.pathname == "http://golang.org/");
    function inputChanged() {
      ...
      window.history.pushState(null, "", "http://golang.org/");
    }
    function popState(e) {
      if (e === null) {
        return;
